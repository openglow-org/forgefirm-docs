...
| [`kernel-module-glowforge`](https://github.com/openglow-org/kernel-module-glowforge) | `glowforge.ko`: the SDMA + EPIT pulse engine, the laser latch, the safety readbacks, and the sensors. `UAPI.md` is the pulse-stream feeder contract. | GPL-2.0-or-later |
